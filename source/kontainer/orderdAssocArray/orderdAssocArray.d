module kontainer.orderdAssocArray.orderdAssocArray;
 ...
 *
 * Simple Usage:
 *  import kontainer.orderdAssocArray;
 * 
 *  void main() {
 *    OrderdAssocArray!(string, int) oaa = new OrderdAssocArray!(string, int);
 *    oaa["abc"] = 123;
 *    oaa["k"]   = 3874;
 *    oaa["abcdef"] = 0;
 *
...
class OrderdAssocArray(KeyType, ValueType) {
